...
agent_communication:
  ...
  - agent: "main"
    message: "USER REPORTED ISSUE: Configuration data isn't populating correctly in the generated EPCIS file. This is a new issue that needs investigation. Need to test the backend EPCIS generation endpoint to identify what specific configuration fields are not being populated correctly. This is a critical functionality issue that affects the core EPCIS generation feature."
  - agent: "testing"
