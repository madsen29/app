...
import { FiEdit2, FiTrash2, FiPlus, FiSettings, FiLogOut, FiPackage } from 'react-icons/fi';
...
const ProjectDashboard = ({ onSelectProject, onCreateProject, onLogout }) => {
  ...
  const isPackagingConfigSetAndLocked = (project) => {
    // Simple check: show if project has serial numbers and any configuration
    return project.serial_numbers && project.serial_numbers.length > 0 && project.configuration;
  };
