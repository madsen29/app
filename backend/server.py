...
class SerialConfiguration(BaseModel):
    ...
    sender_street_address: str = Field(default="")
    sender_city: str = Field(default="")
    sender_state: str = Field(default="")
    sender_postal_code: str = Field(default="")
    sender_country_code: str = Field(default="")
    ...
    receiver_street_address: str = Field(default="")
    receiver_city: str = Field(default="")
    receiver_state: str = Field(default="")
    receiver_postal_code: str = Field(default="")
    receiver_country_code: str = Field(default="")
    ...
    shipper_street_address: str = Field(default="")
    shipper_city: str = Field(default="")
    shipper_state: str = Field(default="")
    shipper_postal_code: str = Field(default="")
    shipper_country_code: str = Field(default="")
